...
electricity<-read.csv("Electric_Consumption_And_Cost__2010_-_Feb_2022_.csv")


electri_comsumption<-electricity%>%
...
#load heat data
heat<-read.csv("Heating_Gas_Consumption_And_Cost__2010_-__Feb_2022_.csv")


heat_comsumption<-heat%>%
  subset(Revenue.Month>=2020-01)%>%
